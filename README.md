...
候选主问题：在预定茶树区域、初始目标数量和位置未知、观察预算相同的条件下，通过视觉反馈选择补充视角，能否相对固定扫描和已有主动视觉方法减少残余漏芽？

这是待检验假设。用户已明确区分视觉区域发现、分级与整机采摘；以有限预算做主动观察的具体实验方案是助手建议，尚待团队用先导数据确认。不要求第一篇完成整套自主采摘产品，也不把“低成本相机”“概率云”“移动视角”单独当作创新。
